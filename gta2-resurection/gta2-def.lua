...
typedef enum PED_STATE_CAR {
    PED_STATE_CAR_25=37,
    PED_STATE_CAR_DO_NOTHING=0,
    PED_STATE_CAR_ENTER_CAR=35,
    PED_STATE_CAR_LEAVE_CAR=36
} PED_STATE_CAR;

typedef struct PlayerS1 PlayerS1, *PPlayerS1;

typedef struct PlayerWeapon PlayerWeapon, *PPlayerWeapon;

typedef struct PedSprite PedSprite, *PPedSprite;

typedef struct PlayerS2 PlayerS2, *PPlayerS2;
...
struct Player_S4 { /* player or somethin similar (money inside) */
    ...
    undefined field_0x2;
    undefined field_0x3;
    uint keyState; /* 16 - attack, 4 - left, 8 - right */
    undefined field_0x8;
    undefined field_0x9;
    undefined field_0xa;
    undefined field_0xb;
...
struct PedS1 {
    ...
    struct Car * car; /* Created by retype action */
...
struct Police_s5 {
    ...
    struct Ped * field_0x468;
    struct Ped * field_0x46c;
    short field_0x470;
    undefined field_0x472;
    undefined field_0x473;
    struct Ped * field_0x474;
    struct Ped * field_0x478;
...
typedef struct SKeyboard SKeyboard, *PSKeyboard;

struct SKeyboard {
    WCHAR keyMapping[256];
    undefined4 field_0x200;
} __attribute__ ((packed));

typedef struct Timing Timing, *PTiming;
...
typedef struct TrafficLights TrafficLights, *PTrafficLights;
...
struct TrafficLights {
    ...
    ushort field_0x190;
    byte phase;
    byte timer; /* Created by retype action */
} __attribute__ ((packed));
